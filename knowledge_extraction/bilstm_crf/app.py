...
class NerBaseDict(object):
    ...
    def recognize(self, text):
        ...
        item["entities"] = [{"word": i, "type": "disease",
                             "recog_label": "dict"} for i in final_wds]
        return item
...
if __name__ == '__main__':
    ...
    def medical_ner():
        ...
        with graph.as_default():
            tf.compat.v1.keras.backend.set_session(sess)
            #model = MedicalNerModel()就是实现好的基于bilstm-crf的用于医疗领域的命名实体识别模型
