...
if __name__ == '__main__':
    ...
    bast_model_filepath = 'C:/Users/xujunyue/Desktop/毕设/KBQA-for-Diagnosis-main/knowledge_extraction/bilstm_crf/checkpoint/best_bilstm_crf_model.h5'
...
# 开始评估模型
    ...
    print("f1_score: {:.4f}, precision_score: {:.4f}, recall_score: {:.4f}, accuracy_score: {:.4f}".format(
        f1, p, r, acc))
