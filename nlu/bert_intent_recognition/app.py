...
class BertIntentModel(object):
    def __init__(self):
        ...
        # self.dict_path = 'C:/Users/胥君玥/Desktop/KBQA-py3.6/nlu/bert_intent_recognition/bert_weight_files/vocab.txt'
        # self.config_path='C:/Users/胥君玥/Desktop/KBQA-py3.6/nlu/bert_intent_recognition/bert_weight_files/bert_config_rbt3.json'
        # self.checkpoint_path='C:/Users/胥君玥/Desktop/KBQA-py3.6/nlu/bert_intent_recognition/bert_weight_files/roberta/bert_model.ckpt'

        self.config_path='./bert_weight_files/bert_config_rbt3.json'
        self.checkpoint_path='./bert_weight_files/roberta/bert_model.ckpt'
        self.dict_path = './bert_weight_files/vocab.txt'
...
if __name__ == '__main__':
    ...
    def bert_intent_recognize():
        ...
        with graph.as_default():
            set_session(sess)
            #BIM = BertIntentModel()实现好的意图识别模型
